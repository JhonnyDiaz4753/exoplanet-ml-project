...
# Limpiar nombres de columnas de X
def clean_column_name(name):
    # Reemplaza todos los caracteres no alfanuméricos por guiones bajos
...
# Limpiar nombres de columnas directamente en X
    X.columns = [clean_column_name(str(col)) for col in X.columns]
