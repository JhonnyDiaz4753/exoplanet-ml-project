...
# BasicBlock con SE
# ------------------------------
class BasicBlock1D_SE(nn.Module):
...
# ------------------------------
# Modelo ResNet con SE Blocks
# ------------------------------
class ResNet1D_SE(nn.Module):
    def __init__(self):
        super().__init__()
        self.layer1 = BasicBlock1D_SE(1, 16)
        self.layer2 = BasicBlock1D_SE(16, 32, downsample=True)
        self.layer3 = BasicBlock1D_SE(32, 64, downsample=True)
        self.layer4 = BasicBlock1D_SE(64, 128, downsample=True)
